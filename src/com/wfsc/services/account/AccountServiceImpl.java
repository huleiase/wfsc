...
public class AccountServiceImpl implements IAccountService {
	...
	@Override
	public Page<Address> findAddressForPage(Page<Address> page,
	...
	@Override
	public Page<Coupon> findCouponForPage(Page<Coupon> page,
			Map<String, Object> paramap) {
		return couponDao.findForPage(page, paramap);
	}
	...
	@Override
	public Page<Favourite> findFavouriteForPage(Page<Favourite> page,
			Map<String, Object> paramap) {
	...
	@Override
	public Page<ReturnProducts> findReturnProductsForPage(
			Page<ReturnProducts> page, Map<String, Object> paramap) {
	...
	public void setDefaultAddr(Long id,Long userId) {
		List<Address> addrlist = addressDao.getEntitiesByPropNames(new String[]{"userid","isDefault"}, new Object[]{userId,1});
