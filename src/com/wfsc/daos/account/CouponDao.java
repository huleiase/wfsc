...
public class CouponDao extends EnhancedHibernateDaoSupport<Coupon> {
	...
	public Page<Coupon> findForPage(Page<Coupon> page, Map<String,Object> paramap){
		...
		try {
			...
			List<Coupon> list = this.findList4PageWithParama(hql.toString(), page
	 ...
	 * @return
	 */
	public Page<Coupon> findPage(Page<Coupon> page, Map<String,Object> paramap){
		...
		page.setTotalCount(totalCount);
		List<Coupon> list = this.findList4Page(hql.toString(), page.getFirst() - 1, page.getPageSize());
		page.setData(list);
		return page;
	}
}