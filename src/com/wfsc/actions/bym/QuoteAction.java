...
//            	cell5.setCellValue("ExWorks Hong Kong");
	...
	public void downloadDesign() throws ParseException{
	...
	/*	List<PropertyFilter> filters = HibernateWebUtils.buildPropertyFilters(Struts2Utils.getRequest());
		...
		Page<DesignerExpense> pagede = new Page<DesignerExpense>(9999);
		...
		if(StringUtils.isNotEmpty(designer)){
			filters.add(new PropertyFilter("EQS_designer1-OR-designer2-OR-designer3", designer));
		}
		if (StringUtils.isNotBlank(isApply)) {
			filters.add(new PropertyFilter("EQS_isApply1-OR-isApply2-OR-isApply3", isApply));
		}
		
		if (StringUtils.isNotEmpty(policyBeginDayStr)) {
			Date policyBeginDay = DATEFORMATHOUR.parse(policyBeginDayStr);
			filters.add(new PropertyFilter("GED_contractDate", policyBeginDay));
		}
		if (StringUtils.isNotEmpty(policyEndDayStr)) {
		...
		pagede = this.designerExpenseManager.getPageDesignerExpense(pagede, filters);
		List<DesignerExpense> list = pagede.getResult();
		downloadDesignExpense(list,designer,isSell);
	}
	...
	public void downloadDesignExpense(List<DesignerExpense> list,String designer,String isSell){
		...
		//	HSSFRow lastrow = sheet.createRow(list.size()+3);
			...
			if ("1".equals(isSell)) {// 销售
				...
				//	HSSFCellStyle rowStyle = titleRow.getRowStyle();
				//	Iterator<Cell> cells = titleRow.cellIterator();
					int startRow = 2;// 起始行
					// int i = 0;//起始列
					for (DesignerExpense de : list) {
						if(StringUtils.isEmpty(de.getContractNo())){
							continue;
						}
						Quote q = this.quoteManager.getQuote(de.getQuoteId());
					...
					//	row.setRowStyle(rowStyle);
						...
						row.getCell(5).setCellValue(q.getVcProcessFre());
						row.getCell(6).setCellValue(q.getVcInstallFre());
						row.getCell(7).setCellValue(q.getUrgentCost()==null?0F:q.getUrgentCost());
						row.getCell(8).setCellValue(q.getLowestFreight()==null?0F:q.getLowestFreight());
						row.getCell(9).setCellValue(
								(q.getSumMoney() / q.getContainTax())
										* (q.getContainTax() - 1));// 稅費
						row.getCell(10).setCellValue(q.getVcAftertreatment());
						row.getCell(11).setCellValue(q.getVcOther());
						Float rt = de.getRealTotel()==null?0F:de.getRealTotel();
						//实际金额
						row.getCell(12).setCellValue(("1".equals(q.getOffsetQuote())?-rt:rt));
						if (designer.equalsIgnoreCase(de.getDesigner1())) {
							row.getCell(13).setCellValue(de.getCounselorRate1());
							Float dm = de.getDesignMony1()==null?0F:de.getDesignMony1();
							//设计费金额
							row.getCell(14).setCellValue(("1".equals(q.getOffsetQuote())?-dm:dm));
							Float rl = de.getRealMony1()==null?0F:de.getRealMony1();
							//实际收款金额
							row.getCell(15).setCellValue(("1".equals(q.getOffsetQuote())?-rl:rl));
							row.getCell(16).setCellValue(de.getIsGetAll1());
							row.getCell(17).setCellValue(de.getIsApply1());
							HSSFCell cell18 = row.getCell(18);
							cell18.setCellValue(de.getApplyDate1());
							cell18.setCellStyle(cellStyle);
							row.getCell(19).setCellValue(de.getRemark1());
						} else if (designer.equalsIgnoreCase(de.getDesigner2())) {
							row.getCell(13)
									.setCellValue(de.getCounselorRate2());
							Float dm = de.getDesignMony2()==null?0F:de.getDesignMony2();
							//设计费金额
							row.getCell(14).setCellValue(("1".equals(q.getOffsetQuote())?-dm:dm));
							Float rl = de.getRealMony2()==null?0F:de.getRealMony2();
							//实际收款金额
							row.getCell(15).setCellValue(("1".equals(q.getOffsetQuote())?-rl:rl));
							row.getCell(16).setCellValue(de.getIsGetAll2());
							row.getCell(17).setCellValue(de.getIsApply2());
							HSSFCell cell18 = row.getCell(18);
							cell18.setCellValue(de.getApplyDate2());
							cell18.setCellStyle(cellStyle);
							row.getCell(19).setCellValue(de.getRemark2());
						} else if (designer.equalsIgnoreCase(de.getDesigner3())) {
							row.getCell(13)
									.setCellValue(de.getCounselorRate3());
							Float dm = de.getDesignMony3()==null?0F:de.getDesignMony3();
							//设计费金额
							row.getCell(14).setCellValue(("1".equals(q.getOffsetQuote())?-dm:dm));
							Float rl = de.getRealMony3()==null?0F:de.getRealMony3();
							//实际收款金额
							row.getCell(15).setCellValue(("1".equals(q.getOffsetQuote())?-rl:rl));
							row.getCell(16).setCellValue(de.getIsGetAll3());
							row.getCell(17).setCellValue(de.getIsApply3());
							HSSFCell cell18 = row.getCell(18);
							cell18.setCellValue(de.getApplyDate3());
							cell18.setCellStyle(cellStyle);
							row.getCell(19).setCellValue(de.getRemark3());
						}
					}
					...
					HSSFCell rtTotleCell = lastrow.createCell(12);
					HSSFCell dmTotleCell = lastrow.createCell(14);
					HSSFCell rlTotleCell = lastrow.createCell(15);
					float sumTotle = 0F;
					float rtTotle = 0F;
					float dmTotle = 0F;
					float rlTotle = 0F;
					for (DesignerExpense de : list){
						...
						if("1".equals(q.getOffsetQuote())){
							...
							if (designer.equalsIgnoreCase(de.getDesigner1())){
								dmTotle -= de.getDesignMony1()==null?0F:de.getDesignMony1();
								rlTotle -= de.getRealMony1()==null?0F:de.getRealMony1();
							}else if(designer.equalsIgnoreCase(de.getDesigner2())){
								dmTotle -= de.getDesignMony2()==null?0F:de.getDesignMony2();
								rlTotle -= de.getRealMony2()==null?0F:de.getRealMony2();
							}else if(designer.equalsIgnoreCase(de.getDesigner3())){
								dmTotle -= de.getDesignMony3()==null?0F:de.getDesignMony3();
								rlTotle -= de.getRealMony3()==null?0F:de.getRealMony3();
							}
						}else{
							sumTotle += q.getSumMoney();
							rtTotle += de.getRealTotel()==null?0F:de.getRealTotel();
					...
					dmTotleCell.setCellValue(ProPrice.getTwoDecimalFloat(dmTotle)+"");
					rlTotleCell.setCellValue(ProPrice.getTwoDecimalFloat(rlTotle)+"");
				...
				//	Iterator<Cell> cells = titleRow.cellIterator();
					...
					//	row.setRowStyle(rowStyle);
						...
						row.getCell(12).setCellValue(("1".equals(q.getOffsetQuote())?-rt:rt));
					//	if (designer.equalsIgnoreCase(de.getDesigner1())) {
						row.getCell(13).setCellValue(de.getDesigner1()==null?"":de.getDesigner1());
							row.getCell(14)
									.setCellValue(de.getCounselorRate1()==null?0F:de.getCounselorRate1());
							Float dm1 = de.getDesignMony1()==null?0F:de.getDesignMony1();
							//设计费1
							row.getCell(15).setCellValue(("1".equals(q.getOffsetQuote())?-dm1:dm1));
							row.getCell(16).setCellValue(de.getHasApply1()==null?0F:de.getHasApply1());
							row.getCell(17).setCellValue(de.getHasNoApply1()==null?0F:de.getHasNoApply1());
							//row.getCell(17).setCellValue(de.getIsApply1());
							HSSFCell cell18 = row.getCell(18);
							cell18.setCellValue(de.getApplyDate1());
							cell18.setCellStyle(cellStyle);
							row.getCell(19).setCellValue(de.getRemark1());
					//	} else if (designer.equalsIgnoreCase(de.getDesigner2())) {
							row.getCell(20).setCellValue(de.getDesigner2()==null?"":de.getDesigner2());
							row.getCell(21)
									.setCellValue(de.getCounselorRate2()==null?0F:de.getCounselorRate2());
							Float dm2 = de.getDesignMony2()==null?0F:de.getDesignMony2();
							//设计费2
							row.getCell(22).setCellValue(("1".equals(q.getOffsetQuote())?-dm2:dm2));
							row.getCell(23).setCellValue(de.getHasApply2()==null?0F:de.getHasApply2());
							row.getCell(24).setCellValue(de.getHasNoApply2()==null?0F:de.getHasNoApply2());
						//	row.getCell(17).setCellValue(de.getIsApply2());
							HSSFCell cell25 = row.getCell(25);
							cell25.setCellValue(de.getApplyDate2());
							cell25.setCellStyle(cellStyle);
							row.getCell(26).setCellValue(de.getRemark2());
					//	} else if (designer.equalsIgnoreCase(de.getDesigner3())) {
							row.getCell(27).setCellValue(de.getDesigner3()==null?"":de.getDesigner3());
							row.getCell(28)
									.setCellValue(de.getCounselorRate3()==null?0F:de.getCounselorRate3());
							Float dm3 = de.getDesignMony3()==null?0F:de.getDesignMony3();
							//设计费3
							row.getCell(29).setCellValue(("1".equals(q.getOffsetQuote())?-dm3:dm3));
							row.getCell(30).setCellValue(de.getHasApply3()==null?0F:de.getHasApply3());
							row.getCell(31).setCellValue(de.getHasNoApply3()==null?0F:de.getHasNoApply3());
						//	row.getCell(32).setCellValue(de.getIsApply3());
							HSSFCell cell32 = row.getCell(32);
							if(de.getApplyDate3()!=null){
								cell32.setCellValue(de.getApplyDate3());
								cell32.setCellStyle(cellStyle);
								
							}
							row.getCell(33).setCellValue(de.getRemark3());
						}
					HSSFRow lastrow = sheet.createRow(startRow+1);
					HSSFCell sumTotleCellTitle = lastrow.createCell(3);
					sumTotleCellTitle.setCellValue("总金额：");
					HSSFCell sumTotleCell = lastrow.createCell(4);
					HSSFCell rtTotleCell = lastrow.createCell(12);
					HSSFCell dm1TotleCell = lastrow.createCell(15);
					HSSFCell dm2TotleCell = lastrow.createCell(22);
					HSSFCell dm3TotleCell = lastrow.createCell(29);
					float sumTotle = 0F;
					float rtTotle = 0F;
					float dm1Totle = 0F;
					float dm2Totle = 0F;
					...
					for (DesignerExpense de : list){
						...
						if("1".equals(q.getOffsetQuote())){
							sumTotle -= q.getSumMoney();
							rtTotle -= de.getRealTotel()==null?0F:de.getRealTotel();
							dm1Totle -= de.getDesignMony1()==null?0F:de.getDesignMony1();
							dm2Totle -= de.getDesignMony2()==null?0F:de.getDesignMony2();
							dm3Totle -= de.getDesignMony3()==null?0F:de.getDesignMony3();
						}else{
							sumTotle += q.getSumMoney();
							rtTotle += de.getRealTotel()==null?0F:de.getRealTotel();
							dm1Totle += de.getDesignMony1()==null?0F:de.getDesignMony1();
					...
					sumTotleCell.setCellValue(ProPrice.getTwoDecimalFloat(sumTotle)+"");
					rtTotleCell.setCellValue(ProPrice.getTwoDecimalFloat(rtTotle)+"");
					dm1TotleCell.setCellValue(ProPrice.getTwoDecimalFloat(dm1Totle)+"");
					dm2TotleCell.setCellValue(ProPrice.getTwoDecimalFloat(dm2Totle)+"");
					dm3TotleCell.setCellValue(ProPrice.getTwoDecimalFloat(dm3Totle)+"");
				...
				//	Iterator<Cell> cells = titleRow.cellIterator();
					...
					//	row.setRowStyle(rowStyle);
						...
						if (designer.equalsIgnoreCase(de.getDesigner1())) {
							row.getCell(13)
									.setCellValue(de.getCounselorRate1());
							Float dm = de.getDesignMony1()==null?0F:de.getDesignMony1();
							//设计费金额
							row.getCell(14).setCellValue(("1".equals(q.getOffsetQuote())?-dm:dm));
						//	row.getCell(15).setCellValue(de.getRealMony1()==null?0F:de.getRealMony1());
							row.getCell(15).setCellValue(de.getIsGetAll1());
							row.getCell(16).setCellValue(de.getIsApply1());
							HSSFCell cell17 = row.getCell(17);
							cell17.setCellValue(de.getApplyDate1());
							cell17.setCellStyle(cellStyle);
							row.getCell(18).setCellValue(de.getRemark1());
						} else if (designer.equalsIgnoreCase(de.getDesigner2())) {
							row.getCell(13)
									.setCellValue(de.getCounselorRate2());
							Float dm = de.getDesignMony2()==null?0F:de.getDesignMony2();
							//设计费金额
							row.getCell(14).setCellValue(("1".equals(q.getOffsetQuote())?-dm:dm));
						//	row.getCell(15).setCellValue(de.getRealMony2());
							row.getCell(15).setCellValue(de.getIsGetAll2());
							row.getCell(16).setCellValue(de.getIsApply2());
							HSSFCell cell17 = row.getCell(17);
							cell17.setCellValue(de.getApplyDate2());
							cell17.setCellStyle(cellStyle);
							row.getCell(18).setCellValue(de.getRemark2());
						} else if (designer.equalsIgnoreCase(de.getDesigner3())) {
							row.getCell(13)
									.setCellValue(de.getCounselorRate3());
							Float dm = de.getDesignMony3()==null?0F:de.getDesignMony3();
							//设计费金额
							row.getCell(14).setCellValue(("1".equals(q.getOffsetQuote())?-dm:dm));
					//		row.getCell(15).setCellValue(de.getRealMony3()==null?0F:de.getRealMony3());
							row.getCell(15).setCellValue(de.getIsGetAll3());
							row.getCell(16).setCellValue(de.getIsApply3());
							HSSFCell cell17 = row.getCell(17);
							cell17.setCellValue(de.getApplyDate3());
							cell17.setCellStyle(cellStyle);
							row.getCell(18).setCellValue(de.getRemark3());
						}
				...
				//	Iterator<Cell> cells = titleRow.cellIterator();
					...
					//	if (designer.equalsIgnoreCase(de.getDesigner1())) {
						row.getCell(13).setCellValue(de.getDesigner1()==null?"":de.getDesigner1());
							row.getCell(14)
									.setCellValue(de.getCounselorRate1()==null?0F:de.getCounselorRate1());
						//	row.getCell(15).setCellValue(de.getDesignMony1()==null?0F:de.getDesignMony1());
						//	row.getCell(16).setCellValue(de.getHasApply1()==null?0F:de.getHasApply1());
						//	row.getCell(17).setCellValue(de.getHasNoApply1()==null?0F:de.getHasNoApply1());
							//row.getCell(17).setCellValue(de.getIsApply1());
						//	HSSFCell cell18 = row.getCell(18);
						...
						//	row.getCell(19).setCellValue(de.getRemark1());
					//	} else if (designer.equalsIgnoreCase(de.getDesigner2())) {
							row.getCell(15).setCellValue(de.getDesigner2()==null?"":de.getDesigner2());
							row.getCell(16)
									.setCellValue(de.getCounselorRate2()==null?0F:de.getCounselorRate2());
					//		row.getCell(22).setCellValue(de.getDesignMony2()==null?0F:de.getDesignMony2());
					//		row.getCell(23).setCellValue(de.getHasApply2()==null?0F:de.getHasApply2());
					//		row.getCell(24).setCellValue(de.getHasNoApply2()==null?0F:de.getHasNoApply2());
						//	row.getCell(17).setCellValue(de.getIsApply2());
					//		HSSFCell cell25 = row.getCell(25);
					...
					//		row.getCell(26).setCellValue(de.getRemark2());
					//	} else if (designer.equalsIgnoreCase(de.getDesigner3())) {
							row.getCell(17).setCellValue(de.getDesigner3()==null?"":de.getDesigner3());
							row.getCell(18)
									.setCellValue(de.getCounselorRate3()==null?0F:de.getCounselorRate3());
						//	row.getCell(29).setCellValue(de.getDesignMony3()==null?0F:de.getDesignMony3());
					//		row.getCell(30).setCellValue(de.getHasApply3()==null?0F:de.getHasApply3());
					//		row.getCell(31).setCellValue(de.getHasNoApply3()==null?0F:de.getHasNoApply3());
						//	row.getCell(32).setCellValue(de.getIsApply3());
					//		HSSFCell cell32 = row.getCell(32);
				...
				//				cell32.setCellStyle(cellStyle);
					//			row.getCell(33).setCellValue(de.getRemark3());
					//		}
							Float designMoney = de.getRealTotel()*((de.getCounselorRate1()==null?0F:de.getCounselorRate1())+(de.getCounselorRate2()==null?0F:de.getCounselorRate2())+(de.getCounselorRate3()==null?0F:de.getCounselorRate3()));
							row.getCell(19).setCellValue(("1".equals(q.getOffsetQuote())?-designMoney:designMoney));
							String isgetAll = "是";
							if("否".equals(de.getIsGetAll1())||"否".equals(de.getIsGetAll2())||"否".equals(de.getIsGetAll3())){
								isgetAll = "否";
							}
							row.getCell(20).setCellValue(isgetAll);
							row.getCell(21).setCellValue(de.getIsApply1());
							HSSFCell cell22 = row.getCell(22);
							if(de.getApplyDate1()!=null){
								cell22.setCellValue(de.getApplyDate1());
								cell22.setCellStyle(cellStyle);
								row.getCell(23).setCellValue(de.getRemark1());
							}
						}
					HSSFRow lastrow = sheet.createRow(startRow+1);
					HSSFCell sumTotleCellTitle = lastrow.createCell(3);
					...
					HSSFCell sumTotleCell = lastrow.createCell(4);
					HSSFCell rtTotleCell = lastrow.createCell(12);
					HSSFCell dmTotleCell = lastrow.createCell(19);
					float sumTotle = 0F;
					float rtTotle = 0F;
					float dmTotle = 0F;
					for (DesignerExpense de : list){
