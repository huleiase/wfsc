...
public class ReportAction extends DispatchPagerAction {
	...
	public String generateUserReport(){
		...
		String xmlData = reportService.generateUserReport(type, year);
	...
	public String financeReport() throws ParseException{
		...
		String numXmlData = reportService.generateOrderNumReport(sdate, edate);
		String moneyXmlData = reportService.generateOrderMoneyReport(sdate, edate);
