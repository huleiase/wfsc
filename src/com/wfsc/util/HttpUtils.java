...
/****************************************************************************************************************************
 * Create Date : Mar 1, 2013 File Name : HttpUtils.java
 * 
 * APEX ITManager是上海泰信科技有限公司自主研发的一款IT综合管理产品，公司拥有完全自主知识产权及专利， 本系统的源代码归公司所有，任何团体或个人不得以任何形式拷贝、反编译、传播，更不得作为商业用途，对
...
public class HttpUtils {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String executeHttpGetForApiKey(String url, List<NameValuePair> nvps, String apiKey,  String token) {
		String responseText = "";
		HttpClient httpclient = null;
		try {
			httpclient = new DefaultHttpClient();
	 ...
	 * @return
	 */
	public static String executeHttpPostForApiKey(String url, List<NameValuePair> nvps, String apiKey, String token) {
		String responseText = "";
		HttpClient httpclient = null;
		try {
			httpclient = new DefaultHttpClient();
