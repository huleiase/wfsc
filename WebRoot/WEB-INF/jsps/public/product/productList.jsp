								...
								<c:forEach var="product" items="${products}">
									<form action="<%=request.getContextPath() %>/private/shopping_add.Q" method="get">
										<li>
											<div class="l-wrap">
												<div class="pic">
													<a class="trackref" href="<%=request.getContextPath() %>/public/details.Q?id=${product.id }"> <img src="${imgPath }${product.prdCode }_small.jpg" width="210" height="210" class="lazy"
															alt="${product.name }"> </a>
												</div>
												<div class="price">
