...
<script type="text/javascript">
	$(function(){
		$.getJSON('/wfsc/public/productcat_category.Q',function(data){
			if(data){
				var catHtml = '';
				for(var i=0; i<data.length; i++){
					var category = data[i];
					var html = '<li class="mod_cate_li"><div class="mod_cate_r1"><h3><a href="/wfsc/public/list.Q?code=' + category.code + '">' + category.name + '</a></h3><i class="mod_cate_arrow"></i><div class="mod_subcate"><div class="mod_subcate_main">';
						...
						for(var j=0; j<children1.length; j++){
							...
							if(children2){
								for(var k=0; k<children2.length; k++){
									...
									var html3 = '<a href="/wfsc/cat/list/' + category3.code + '">' + category3.name + '</a>';
									html2 += html3;
								}
							}
							html2 += '</dd></dl>';
