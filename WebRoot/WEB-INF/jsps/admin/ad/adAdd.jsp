...
<script type="text/javascript">
	...
	function backToLisk(){
		window.location.href = "/wfsc/admin/ad_index.Q";
	}
...
<input type="hidden" id="tab" value="m2"/>
  ...
  <div class="row-fluid">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/wfsc/admin/ad_save.Q" method="post" class="form-horizontal" id="adForm" enctype="multipart/form-data">
          	<input type="hidden" name="advConfig.id" id="advConfigId" value="${advConfig.id }">
            <div class="control-group">
              <label class="control-label">广告类型</label>
              <div class="controls">
              	<select name="advConfig.adType" id="adType" style="width:579px;">
           ...
           <div class="control-group">
            ...
            <div class="control-group">
            <div class="controls"><font color="red">*&nbsp;&nbsp;&nbsp;&nbsp;幻灯片广告尺寸（755 x 345）<br/>*&nbsp;&nbsp;&nbsp;&nbsp;普通广告尺寸（1190 x 90）</font></div>
            </div>
