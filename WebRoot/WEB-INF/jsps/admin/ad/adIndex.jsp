	...
	function delByIds(){
		...
		if(selectCheckbox.length<1){
			...
			art.dialog({
			    ...
			    ok: function () {
			    	$.ajax({
						url:"/wfsc/admin/ad_deleteByIds.Q",
						data:{"ids":ids},
						dataType:'json',
	...
	<body>
		...
		<div id="content">
			<div id="content-header">
				<div id="breadcrumb">
					<a href="/wfsc/admin/admin_index.Q" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
				</div>
			</div>
			<div class="container-fluid">
				<div class="widget-box">
					<div class="widget-content">
						<form action="/wfsc/admin/ad_index.Q" method="post" id="adQueryForm">
