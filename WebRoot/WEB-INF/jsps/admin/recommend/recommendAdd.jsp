...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			function backToLisk(){
				window.location.href="/wfsc/admin/recommend_list.Q";
			}
			$(function(){
			...
			function checkForm(){
				if($("#prdCode").val().trim() === ''){
					...
					$.ajax({
						url:'/wfsc/admin/recommend_check.Q',
						type:'get',
						async:false,
				...
				<div class="row-fluid">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form action="/wfsc/admin/recommend_add.Q" method="post" class="form-horizontal">
