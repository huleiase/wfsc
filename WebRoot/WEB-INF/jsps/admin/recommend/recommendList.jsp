	...
	<head>
		...
		<script type="text/javascript">
			...
			function cancelRecommend(recommendId){
				if(confirm("确定取消吗？")){
					$.ajax({
						url : '/wfsc/admin/recommend_cancel.Q',
						type : 'get',
						data : {id:recommendId},
						dataType : 'json',
			...
			function addRecommend(){
				window.location.href="/wfsc/admin/recommend_preAdd.Q";
			}
		</script>
	</head>
			...
			<div class="container-fluid">
				<div class="widget-box">
					<div class="widget-content">
						<form action="/wfsc/admin/recommend_list.Q" method="post" id="recommendForm">
