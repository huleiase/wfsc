...
<script type="text/javascript">
	...
	function addOrUpdate(id){
		var url = "/wfsc/admin/comments_commentsInput.Q";
		if(id){
			url+="?id="+id;
		}
	...
	function detail(id){
		var url = "/wfsc/admin/comments_detail.Q?id="+id;
		window.location.href = url;
	}
	function delByIds(){
		...
		if(selectCheckbox.length<1){
			...
			art.dialog({
			    ...
			    ok: function () {
			    	$.ajax({
						url:"/wfsc/admin/comments_deleteByIds.Q",
						data:{"ids":ids},
						dataType:'text',
						success:function(data){
							if("ok"==data){
								window.location.href="/wfsc/admin/comments_manager.Q";
							}else{
								art.dialog({
									time: 2,
									content: '删除失败！'
...
<div class="container-fluid">
      <div class="widget-box">
        <div class="widget-content">
          <form action="/wfsc/admin/comments_manager.Q" method="post" id="commentsQueryForm">
