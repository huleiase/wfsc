           ...
           <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
            	...
            	<s:else>
            		<a rel="attachment" href='/wfsc/<s:property value="products.picUrl1"/>' title="点击查看图片" target="_blank">
					<img src='/wfsc/<s:property value="products.picUrl1"/>' width="24" height="16" alt="点击查看图片"/> </a>
            	</s:else>
              </div>
            </div>
            <div class="control-group">
              ...
              <s:if test="products.picUrl2==null">
            	...
            	<s:else>
            		<a rel="attachment" href='/wfsc/<s:property value="products.picUrl2"/>' title="点击查看图片" target="_blank">
					<img src='/wfsc/<s:property value="products.picUrl2"/>' width="24" height="17" alt="点击查看图片"/> </a>
            	</s:else>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
               <s:if test="products.picUrl3==null">
            	...
            	<s:else>
            		<a rel="attachment" href='/wfsc/<s:property value="products.picUrl3"/>' title="点击查看图片" target="_blank">
					<img src='/wfsc/<s:property value="products.picUrl3"/>' width="24" height="17" alt="点击查看图片"/> </a>
            	</s:else>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
            	...
            	<s:else>
            		<a rel="attachment" href='/wfsc/<s:property value="products.picUrl4"/>' title="点击查看图片" target="_blank">
					<img src='/wfsc/<s:property value="products.picUrl4"/>' width="24" height="17" alt="点击查看图片"/> </a>
            	</s:else>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
            	...
            	<s:else>
					...
					<img src='/wfsc/<s:property value="products.picUrl5"/>' width="24" height="17" alt="点击查看图片"/> </a>
            	</s:else>
              </div>
            </div>
             <div class="control-group">
