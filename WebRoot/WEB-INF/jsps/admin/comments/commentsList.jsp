              ...
              <s:if test="#request.commentslist.size>0">
                <s:iterator value="#request.commentslist" var="comments">
                 <tr>
                  ...
                  <td><a href='/wfsc/admin/products_detail.Q?prdCode=<s:property value="prdCode"/>' target="_blank"> <s:property value="prdName"/> </a></td>
                   <td><a href='/wfsc/admin/products_detail.Q?prdCode=<s:property value="prdCode"/>' target="_blank"> <s:property value="prdCode"/>  </a></td>
                  ...
                  <td><s:date name="pdate" format="yyyy-MM-dd hh:mm:ss" /></td>
                  <td>
