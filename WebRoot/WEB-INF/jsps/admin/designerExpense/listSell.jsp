                              ...
                              <td><s:property value="counselorRate1"/></td>
                               <td><s:property value="designMony1"/></td>
                                <td><s:property value="hasApply1"/></td>
                                 <td><s:property value="hasNoApply1"/></td>
                                  <td> <s:date name="applyDate1" format="yyyy-MM-dd" /></td>
                                 <td><s:property value="remark1"/></td>
                                  <td><s:property value="designer2"/></td>
                              <td><s:property value="counselorRate2"/></td>
                               <td><s:property value="designMony2"/></td>
                                <td><s:property value="hasApply2"/></td>
                                 <td><s:property value="hasNoApply2"/></td>
                                  <td> <s:date name="applyDate2" format="yyyy-MM-dd" /></td>
                                 <td><s:property value="remark2"/></td>
                                 <td><s:property value="designer3"/></td>
                              <td><s:property value="counselorRate3"/></td>
                               <td><s:property value="designMony3"/></td>
                                <td><s:property value="hasApply3"/></td>
                                 <td><s:property value="hasNoApply3"/></td>
                                  <td> <s:date name="applyDate3" format="yyyy-MM-dd" /></td>
                                 <td><s:property value="remark3"/></td>
                                 <td><s:property value="designTotelMoney"/></td>
                </tr>
               </s:iterator>
               </s:if>
                <s:else>
