...
<script type="text/javascript">
	...
	function addOrUpdate(id){
		var url = "/wfsc/admin/productcat_input.Q";
		if(id){
			url+="?id="+id;
		}
	...
	function delByIds(){
		...
		if(selectCheckbox.length<1){
			...
			art.dialog({
			    ...
			    ok: function () {
			    	$.ajax({
						url:"/wfsc/admin/productcat_deleteByIds.Q",
						data:{"ids":ids},
						dataType:'json',
...
<div class="container-fluid">
      <div class="widget-box">
        <div class="widget-content">
          <form action="/wfsc/admin/productcat_index.Q" method="post" id="productCatQueryForm">
