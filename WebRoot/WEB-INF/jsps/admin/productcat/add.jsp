...
<script type="text/javascript">
	...
	function checkProductCatForm(){
		...
		if($("#catLevel").val() == '1' && $("#picName").val().trim() === ''){
			alert("请选择分类图标");
			return false;
		}
		return true;
	...
	function changeLevel(el){
		if(levelData == null){
			$.ajax({
				url:'/wfsc/admin/productcat_allPrdCat.Q',
				dataType:'json',
				type:'get',
				async:false,
  ...
  <div class="row-fluid">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/wfsc/admin/productcat_save.Q" method="post" class="form-horizontal" id="productCatForm" enctype="multipart/form-data">
            ...
            <div class="control-group">
            <div class="controls"><font color="red">*&nbsp;&nbsp;&nbsp;&nbsp;分类图标尺寸（30 x 40）</font></div>
            </div>
