...
<script type="text/javascript">
	...
	function downloadSell(){
		var url = "<%=basePath%>admin/designerOrder_exportDesignerOrderData.Q?flag=3"
...
<div class="container-fluid">
      <div class="widget-box">
        <div class="widget-content">
          <form action="admin/designerOrder_managerInCome.Q" method="post" id="queryForm">
