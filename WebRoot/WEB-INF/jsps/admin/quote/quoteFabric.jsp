              ...
              <s:if test="#request.quoteFabricList.size>0">
                ...
                <c:set value='${obj.vcIndex}' var="vcIndex"/>
                 ...
                 <input type="hidden" value="<s:property value="amountrmb"/>" id="amountrmb${vcCount }" name="quoteFabricList[${vcIndex }].amountrmb" />
	                 ...
	                 <input type="hidden" value="<s:property value="dhjHKVcPrice"/>" id="dhjHKVcPrice${vcCount }" />
	                 ...
	                 <input type="hidden" value="<s:property value="vcSubLay"/>" id="vcSubLay${vcCount }" name="quoteFabricList[${vcIndex }].vcSubLay" />
	                 <input type="hidden" value="<s:property value="vcRealityAog"/>" id="vcRealityAog${vcCount }" name="quoteFabricList[${vcIndex }].vcRealityAog" />
	                 <input type="hidden" value="<s:property value="vcShipmentNum"/>" id="vcShipmentNum${vcCount }" name="quoteFabricList[${vcIndex }].vcShipmentNum" />
			    ...
			    <td><input type="text" value="<s:property value="vcComposition"/>" id="vcComposition${vcCount }" name="quoteFabricList[${vcIndex }].vcComposition"  class="widthShort"/></td>
			     ...
			     <td><input type="text" onclick="setTrVcTotal(${vcCount });" value="<s:property value="vcTotalStr"/>" id="vcTotal${vcCount }" readonly="readonly" name="quoteFabricList[${vcIndex }].vcTotal"  class="widthShort"/></td>
