...
<script type="text/javascript">
	...
	function checkForm(){
		...
		if(!projectType){
			art.dialog({title:"温馨提示",content:"项目性质必填",ok:true});
			return;
		}
          ...
          <input type="hidden" id="vcattncompany" value='${vcattncompany }' >
	         ...
	         <div class="clear"></div>
	          ...
	          <label class="span1" for="inputSuccess" style="margin-top:5px;width:93px;">量窗费</label>
	            ...
	            <input name="quote.taxes" id="taxes" type="text" class="span3"  value="${ quote.taxes}" onkeyup="setSumMoney();">
	         ...
	         <input class="blankInput" for="inputSuccess" style="" name="quote.titleCol5" value="${ quote.titleCol5}" id="titleCol5" type="text">
	            ...
	            <select name="quote.projectType" id="projectType" style="width:204px;float: left;" class="span3">
	             	<option value="">请选择</option>
	         ...
	         <div class="clear"></div>
	          ...
	          <div class="controls">
	            ...
	            <input name="quote.subtotal" id="subtotal" type="text" class="span3"  value="${ quote.subtotalStr}" readonly="readonly">
	         ...
	         <div class="clear"></div>
	          <div class="controls">
	            ...
	            <input name="quote.sumMoney" id="sumMoney" type="text" class="span3"  value="${ quote.sumMoneyStr}" readonly="readonly">
