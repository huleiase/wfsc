              ...
              <s:if test="#request.page.data.size>0">
                <s:iterator value="#request.page.data" var="obj">
                 <tr>
                  ...
                  <td><a title="点击查看详细信息" href='<%=request.getContextPath()%>/admin/customer_detail.Q?id=<s:property value="id"/>' target="_blank"><s:property value="companyName"/></a></td>
                  ...
                  <td>
                  <w:permission permissionId="<%=PermissionId.BASIC_CUSTOMER_MGT_UPDATE%>">
