									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0"
										...
										<tr>
											<td width="925" height="25" align="left" class="">
													<form action="admin/customer_importData.Q" method="post" enctype="multipart/form-data" id="importForm">
													<center>
											...
											<div class="tishi_nr">
												<h1 class="nerrbeijing5">
													...
													<p>
														您可在此处下载模板,点击
														<samp>
														<a style="text-decoration: underline; color: rgb(255, 102, 0);" title="" href="admin/customer_getCustomerExcelModel.Q">下载模板</a>！
													</p>
												</h1>
											</div>
										</div>
