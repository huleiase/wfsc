									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0"
										...
										<tr>
											<td width="925" height="25" align="left" class="">
													<form action="admin/fabric_importData.Q" method="post" enctype="multipart/form-data" id="importForm">
													<input type="hidden" name="importFactory" value="${importFactory }">
													<center>
										...
										<div class="tishi_info">
											<div class="tishi_nr">
												<h1 class="nerrbeijing5">
													...
													<p>
														2、文件的大小不要大于20MB，以免影响上传的时间，而造成页面超时
													</p>
													<p>
													...
													<p>
														您可在此处下载模板,点击
														<samp>
														<a style="text-decoration: underline; color: rgb(255, 102, 0);" title="" href="admin/fabric_getFabricExcelModel.Q">下载模板</a>！
													</p>
												</h1>
											</div>
										</div>
