...
var basePath = "<%=basePath%>";
	...
	function operPurchase(id,oper){
		...
		var url = basePath+"admin/purchase_input.Q?isToPur=1&id="+id+"&oper="+oper+"&currPageNo="+pageNo+"&pageSize="+pageSize+"&orderStatus="+orderStatus;
		if(oper==3 || oper==4){
			window.open(url,"打印"); 
		}else{
...
<div class="container-fluid">
      <div class="widget-box">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5>待采购单列表</h5>
            <w:permission permissionId="<%=PermissionId.PROCESS_TO_PURCHASE_MGT_DELETE%>">
