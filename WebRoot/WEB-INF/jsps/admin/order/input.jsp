	           ...
	           <div class="controls">
	         	 <label class="span1" for="inputSuccess" style="margin-top:5px;width:120px;">运输方式</label>
	           	<select name="order.transportMode" id="transportMode" style="width:202px;float: left;" class="span3">
					...
					<option value="3" <c:if test="${order.transportMode=='3'}">selected</c:if>>德邦标准卡航:江南大道营业部</option>
	         ...
	         <div class="controls">
	            ...
	            <label class="span1" for="inputSuccess" style="margin-top:5px;width:120px;">shipping service</label>
	           	<select name="order.shippingService" id="shippingService" style="width:202px;float: left;" class="span3" >
					...
					<option value="11" <c:if test="${order.shippingService=='11'}">selected</c:if>>UPS Worldwide Express on our A/C E8838F</option>
					<option value="12" <c:if test="${order.shippingService=='12'}">selected</c:if>>UPS Worldwide Saver on our A/C E8838F</option>
	             </select>
	            </div>
	          <div class="clear"></div>
