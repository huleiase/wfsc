...
<body>
	...
	<div class="wf_header">
		<div class="grid_c1">
			<div class="mod_logo">
				<h1>
					<a href="<%=request.getContextPath() %>/public/index.Q"><img src="<%=request.getContextPath() %>/images/logo.jpg" alt="广州诚光进销存"> </a>
				</h1>
			</div>
...
function addToFavourite(cid, prdCode, obj){
	$.ajax({
		url : '/wfsc/private/shopping_addFav.Q',
		type : 'get',
