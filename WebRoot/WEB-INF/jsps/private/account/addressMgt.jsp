...
<script type="text/javascript">
	...
	function delAddr(id){
		$.ajax({
				url:"/wfsc/private/account_delAddr.Q",
				data:{"id":id},
				dataType:'text',
				success:function(addr){
					if(addr="sucess"){
...
<div class="linknav">
  <div class="breadcrumb">
  	 <a class="order_a1" href="">会员中心</a>&gt; <a class="order_a2" href="">地址管理</a></span>
  </div>
</div>
<div class="order_center">
    ...
    <div class="order_r">
      ...
      <form action="/wfsc/private/account_addAddr.Q" id="myform" method="post">
