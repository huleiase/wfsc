...
<!--我的订单开始-->
<div class="linknav">
  <div class="breadcrumb"> <a class="order_a1" href="<%=request.getContextPath() %>/private/account_userInfo.Q">个人中心</a>&gt; <a class="order_a2" href="<%=request.getContextPath() %>/private/account_ordersMgt.Q">我的订单</a>&gt; <a class="order_a2">订单详情</a></span> </div>
</div>
  ...
  <dl class="order_base_dl" style="margin-bottom:30px;">
    ...
    <dd class="order_base_qingdan">
      ...
      <dl class="order_qingdan_c">
        <dd class="qingdan_name"><a target="_blank" href="/wfsc/public/details.Q?code=<s:property value='prdCode'/>"> <s:property value="prodName"/></a></dd>
