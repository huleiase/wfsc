...
<script type="text/javascript">
	function searchOrder(){
		...
		window.location.href='/wfsc/private/account_ordersMgt.Q?status='+status;
	}
</script>
</head>
<body>
       ...
       <table class="order_tab">
          ...
          <tr class="order_tr2">
            ...
            <s:iterator value="#order.ordersDetail" var="detail">
           	 	<a target="_blank" href='/wfsc/public/details.Q?code=<s:property value="prdCode"/>'><img src='${imgServer }<s:property value="prdImage"/>'></a>
           	 	<!--<span class="clearb yunfei"><a href='/wfsc/public/details.Q?id=<s:property value="prdId"/>'>申请退货</a></span> -->
           </s:iterator>
             </td>
            ...
            <td class="order_td7"><s:date name="odate" format="yyyy-MM-dd HH:mm:ss" />
             ...
             <td class="order_td5">
             		<s:if test="#order.status==0">未支付</s:if>
                  	<s:elseif test="#order.status==1">已支付</s:elseif>
                  	<s:elseif test="#order.status==2">已发货</s:elseif>
                  	<s:elseif test="#order.status==3">已完成</s:elseif>
                  	<s:elseif test="#order.status==9">已取消</s:elseif>
            </td>
            <td class="order_td8">
            <span class="clearb yunfei"><a class="safe_a" href='/wfsc/private/account_ordersDetai.Q?orderNo=<s:property value="orderNo"/>'>订单详情</a></span>
            <s:if test="#order.status==0">
            	<span class="clearb yunfei"><a class="safe_a" href='/wfsc/private/payment_payment.Q?orderNo=<s:property value="orderNo"/>'>立即支付</a></span>
                <span class="clearb yunfei"><a class="safe_a" href='/wfsc/private/account_changeOrderState.Q?orderNo=<s:property value="orderNo"/>&orderState=9'>取消订单</a></span>
            </s:if>
            <s:if test="#order.status==2">
            	<span class="clearb yunfei"><a class="safe_a" href='/wfsc/private/account_changeOrderState.Q?orderNo=<s:property value="orderNo"/>&orderState=3'>确认收货</a></span>
            </s:if>
            <s:if test="#order.status==3">
            	<span class="clearb yunfei"><a class="safe_a" href='/wfsc/private/account_commentsMgt.Q'>去评论</a></span>
            </s:if>
            </td>
          </tr>
         </s:iterator>
