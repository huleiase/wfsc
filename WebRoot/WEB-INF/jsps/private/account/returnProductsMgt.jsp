...
<div class="linknav">
  <div class="breadcrumb">
  	 <a class="order_a1" href="">会员中心</a>&gt; <a class="order_a2" href="">退换货服务</a></span>
  </div>
</div>
     ...
     <div class="order_r">
       ...
       <div class="clearb"></div>
         <table class="order_tab">
          ...
          <tr class="order_tr3">
            <td class=""><a href='/wfsc/private/account_returnProductsDetail.Q?id=<s:property value="id"/>' target="_blank"><s:property value="returnCode"/></a></td>
            <td class=""> <s:property value="orderNo"/></td>
            <td class="">  <a href='/wfsc/public/details.Q?code=<s:property value="prdCode"/>' target="_blank"><s:property value="prdName"/></a></td>
            <td class=""><s:date name="returnDate" format="yyyy-MM-dd hh:mm:ss" /></td>
            <td class=""> <s:property value="status"/></td>
            <td class="">
           <a class="mr_10" target="_blank" href='/wfsc/private/account_returnProductsDetail.Q?id=<s:property value="id"/>'>查看</a>
            </td>
          </tr>
          </s:iterator>
      </table>
