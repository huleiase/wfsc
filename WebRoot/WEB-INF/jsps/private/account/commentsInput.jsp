...
<div class="linknav">
  <div class="breadcrumb">
  	 <a class="order_a1" href="">会员中心</a>&gt; <a class="order_a2" href="">商品评论</a></span>
  </div>
</div>
    ...
    <!--右侧开始-->
     <div class="order_r">
       ...
       <table class="order_tab">
          ...
          <tr class="order_tr2">
            <td class="order_td1">
              <div class="p-img fl"><a target="_blank" href='/wfsc/public/details.Q?code=<s:property value="#request.od.prdCode"/>'><img height="80" width="100" src='${imgServer }<s:property value="#request.od.prdCode"/>_small.jpg'></a></div>
        ...
        <div class="quiz">
            ...
            <div class="quiz_content">
                <form action="/wfsc/private/account_saveComments.Q" id="myform" method="post">
