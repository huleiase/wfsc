...
<div class="linknav">
  <div class="breadcrumb">
  	 <a class="order_a1" href="">会员中心</a>&gt; <a class="order_a2" href="">我的收藏</a></span>
  </div>
</div>
     ...
     <div class="order_r">
       ...
       <div class="clearb"></div>
         <table class="order_tab">
          ...
          <tr class="order_tr3">
            <td class=""><a href='/wfsc/public/details.Q?id=<s:property value="products.id"/>' target="_blank"><s:property value="products.name"/></a></td>
            ...
            <td class="">
           <a class="mr_10" target="_blank" href='/wfsc/private/shopping_add.Q?num=1&prdCode=<s:property value="products.prdCode"/>'>添加至购物车</a>
