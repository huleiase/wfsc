...
<script type="text/javascript">
	...
	function modifyAddr(id){
		$.ajax({
				url:"/wfsc/private/account_modifyAddr.Q",
				data:{"id":id},
				dataType:'json',
	...
	function setDefault(id){
		$.ajax({
				url:"/wfsc/private/account_setDefault.Q",
				data:{"id":id},
				dataType:'text',
				success:function(addr){
					if(addr="sucess"){
						window.location.href='/wfsc/private/account_addrMgt.Q';
					}
	...
	function delFavorite(id){
		$.ajax({
				url:"/wfsc/private/account_delFavorite.Q",
				data:{"id":id},
				dataType:'text',
				success:function(addr){
					if(addr="sucess"){
						window.location.href='/wfsc/private/account_favoriteMgt.Q';
					}
...
<div class="linknav">
  <div class="breadcrumb">
  	 <a class="order_a1" href="">会员中心</a>&gt; <a class="order_a2" href="">商品评价</a></span>
  </div>
</div>
     ...
     <div class="order_r">
       ...
       <div class="tab">
          ...
          <tr class="order_tr3">
            ...
            <td class=""><a href='/wfsc/public/details.Q?code=<s:property value="prdCode"/>' target="_blank"><s:property value="prodName"/></a></td>
            <td class=""><s:date name="buyDate" format="yyyy-MM-dd hh:mm:ss" /></td>
            <td class="">
            <span class="clearb yunfei"><a class="safe_a" href='/wfsc/private/account_commentsInput.Q?detailId=<s:property value="id"/>' targer="_blank">
            我要评价</a></span>
            </td>
          </tr>
          </s:iterator>
        ...
        <!--<div class="page">
         ...
         <s:iterator value="#request.hasorderDetails" var="hasorderDetail">
          <tr class="order_tr3">
            ...
            <td class=""><s:date name="buyDate" format="yyyy-MM-dd hh:mm:ss" /></td>
            <td class="">
            <span class="clearb yunfei"><a class="safe_a" href='/wfsc/private/account_commentsDetail.Q?detailId=<s:property value="id"/>'>查看</a></span>
            </td>
          </tr>
          </s:iterator>
