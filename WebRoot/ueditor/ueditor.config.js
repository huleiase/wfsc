...
(function () {
     ...
     */
    window.UEDITOR_HOME_URL = "/wfsc/ueditor/";
...
, toolbars: [["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","searchreplace","preview","help","insertimage","insertvideo","emotion","map","spechars","attachment","pagebreak","bold","italic","underline","fontborder","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","lineheight","rowspacingtop","rowspacingbottom","paragraph","touppercase","tolowercase","fontfamily","fontsize","indent","removeformat","autotypeset","customstyle","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow"],[]]
